...
namespace TestePortal.Pages.CadastroPage
{
    ...
    {
        public static async Task<(Pagina pagina, FluxosDeCadastros fluxosDeCadastros)> GestorasInternas(IPage Page, IBrowserContext context, NivelEnum nivelLogado)
        {
            ...
            try
            {
                ...
                if (CadastroGestorasInternas.Status == 200)
                {
                    ...
                    if (nivelLogado == NivelEnum.Master)
                    {
                        ...
                        var gestoraInternaExiste = GestoraInternaRepository.VerificaExistenciaGestoraInterna("16695922000109", "robo@zitec.ai");
                        ...
                        if (gestoraInternaExiste)
                        {
                            ...
                            var verificarStatus = GestoraInternaRepository.VerificarStatus("16695922000109", "robo@zitec.ai");
                            ...
                            var apagarGestoraInterna = GestoraInternaRepository.ApagarGestoraInterna("16695922000109", "robo@zitec.ai");
