            ...
            try
            {
                ...
                if (CadastroConsultorias.Status == 200)
                {
                    ...
                    if (nivelLogado == NivelEnum.Master)
                    {
                        ...
                        var ApagarConsultorias2 = ConsultoriasRepository.ApagarConsultorias("16695922000109", "robo@zitec.ai");
                       ...
                       return false; // O arquivo não foi encontrado
                        ...
                        var ConsultoriasExiste = ConsultoriasRepository.VerificaExistenciaConsultorias("16695922000109", "robo@zitec.ai");
                        ...
                        if (ConsultoriasExiste)
                        {
                            ...
                            var verificarStatus = ConsultoriasRepository.VerificarStatus("16695922000109", "robo@zitec.ai");
                            if (verificarStatus)
                            {
                            ...
                            var ApagarConsultorias = ConsultoriasRepository.ApagarConsultorias("16695922000109", "robo@zitec.ai");
