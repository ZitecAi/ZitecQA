...
namespace TestePortal.Pages
{
    ...
    {
        public static async Task<Model.Pagina> Carteira (IPage Page, IConfiguration config)
        {
            ...
            try
            {
                ...
                var CadastroCarteira = await Page.GotoAsync(portalLink + "/Carteira/Carteiras.aspx");
