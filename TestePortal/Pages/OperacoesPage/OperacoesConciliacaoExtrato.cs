...
namespace TestePortal.Pages.OperacoesPage
{
    ...
    {
        public static async Task<(Pagina pagina, Conciliacao conciliacao )> ConciliacaoExtrato (IPage Page,  NivelEnum nivelLogado)
        {
            ...
            try
            {
                ...
                if (ConciliacaoExtrato.Status == 200)
                {
                    ...
                    pagina.BaixarExcel = Excel.BaixarExcel(Page).Result;
