...
using TestePortalConsultoria.Pages;
using System.Net.Http.Headers;
using System.Drawing;
using System.Linq;

namespace TestePortalConsultoria
{
    class Program
    {
        ...
        public static async Task Main(string[] args)
        {
...

            {
                ...
                {
                    listaPagina.Add(await TestePortalConsultoria.Pages.LoginGeral.Login(Page, usuario));


                    if (usuario.Nivel == Usuario.NivelEnum.Consultoria)
                    {
            ...
            try
            {
                EmailPadrao emailPadrao = new EmailPadrao(
                    "todos@zitec.ai",
                    "Relatório das páginas do portal nível consultoria.",
